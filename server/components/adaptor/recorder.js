...
var Recorder = function (chunk, cb) {
    var self = this,
        baseSnapshotUrl = 'http://localhost:9000/api/documents/snapshot/' + chunk._id,
            ...
            ph.createPage(function (p) {
                p.open('file://' + __dirname + '/odf.html', function (status) {
                    if (status === 'success') {
                        ...
                        page.evaluate(loadDocument, function (){}, baseSnapshotUrl, chunk.operations);
                    } else {
